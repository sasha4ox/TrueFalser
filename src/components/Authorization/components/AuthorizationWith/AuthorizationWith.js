    ...
    return (
      <div className="signInWith">
          ...
          <div className="withItemContainer">
              <a href={googleUrl} className="item" onClick={setAuthorizationUrlGoogle}>
              ...
              <a href={facebookUrl} className="item" onClick={setAuthorizationUrlFacebook}>
                  <img alt="Facebook" src="https://www.facebook.com/images/fb_icon_325x325.png"/>
                  <span>Facebook</span>
              </a>
          </div>
      </div>
